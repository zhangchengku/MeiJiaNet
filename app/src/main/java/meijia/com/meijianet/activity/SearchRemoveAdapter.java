 ...
 *         Create：2018/2/24
 */
public class SearchRemoveAdapter extends BaseAdapter {
    private Context mContext;
    private List<String> mDatas;
    private int type = 0;

    public SearchRemoveAdapter(Context context, List<String> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    public View getView(int position, ViewGroup parent) {
        ...
        tagTv.setTextColor(Color.parseColor("#dddddd"));
        return tagTv;
    }
}
