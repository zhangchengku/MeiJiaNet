package meijia.com.meijianet.adpter.menu;
...
import meijia.com.meijianet.util.DeviceUtil;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        upLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, dpTpPx(1.0f)));
    ...
    public void setMenuwidthP(int p){
        this.menuHeighPercent = p;
    }


    public int getMoveWidth(final LinearLayout layout, int page){
        Log.e("000", "getMoveWidth: "+page );
        View checkView = layout.getChildAt(page);
        int k = checkView.getMeasuredWidth();
        int l = checkView.getLeft();
        int width = l + k / 2 - getScreenWidth(layout.getContext()) / 2;
        return width;
    }
    ...
    public void setDropDownMenu(@NonNull List<String> tabTexts, @NonNull List<View> popupViews, @NonNull View contentView) {
        ...
        popupMenuViews.setLayoutParams(new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                (int) (DeviceUtil.getScreenSize(getContext()).y*menuHeighPercent)));
        popupMenuViews.setVisibility(GONE);
        containerView.addView(popupMenuViews, 2);

        for (int i = 0; i < popupViews.size(); i++) {
            if (i == popupViews.size()-1){
    ...
    private void addTab(@NonNull final List<String> tabTexts,final int i) {
        ...
        tab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (i == tabTexts.size()-1){
                    ...
                    menuHeighPercent = 0.5f;
                }
                switchMenu(tab,menuHeighPercent);
            }
        });
...
//        }
     ...
     *
     * @param target
     * @param menuHeighPercent
     */
    private void switchMenu(final View target, float menuHeighPercent) {
...
//                        @Override
//                        public void run() {
//                            mHorizontalScrollView.smoothScrollTo(getMoveWidth(tabMenuView, current_tab_position),0);
//                        }
//                    });
                }
            } else {
