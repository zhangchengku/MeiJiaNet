...
public class CollectAdapter2 extends CommonRecyclerAdapter<MyCollectInfo> {
    ...
    public void setOnMyItemClickListener(meijia.com.meijianet.activity.CollectAdapter.onMyItemClickListener listener){
        this.mListener = listener;
    }

    public CollectAdapter2(Context context, List<MyCollectInfo> data) {
        super(context, data, R.layout.item_rv_collect2);
        isCheck = false;
        initMap();
    }
...
//        setM2(((TextView) holder.getView(R.id.tv_item_fangyuan_msg)));
    ...
    private void removeData(int position) {
            OkHttpUtils.post()
                    ...
                    .addParams("houseids", String.valueOf(mData.get(position).getId()))
                    .build()
