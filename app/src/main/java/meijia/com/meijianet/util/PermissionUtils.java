 ...
 * </pre>
 * </p>
 * Created by zhaoyu1 on 2016/5/11.
 */
public final class PermissionUtils {
     ...
     */
    public static void checkPermissions(final Object obj, final List<String> permissions, final List<String> permissionNames, final int requestCode, final Runnable runnable) {
                    ...
                    if (!activity.isFinishing()) {
                        ...
                        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                request(obj, permissionsList, requestCode);
                            }
                        });
                        builder.create().show();
                    }
     ...
     * @return
     */
    public static void checkOnePermission(final Object obj, final String permission, final String explain, final int requestCode, final Runnable runnable) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            // 检测类型
            Activity activity = getActivity(obj);
            if (activity == null) {
     ...
     */
    public static void requestResult(String[] permissions, int[] grantResults, final Runnable successRunnable, final Runnable failRunnable) {
     ...
     */
    private static void request(final Object object, List<String> permissionsList, int requestCode) {
        if (object instanceof Activity) {
            ActivityCompat.requestPermissions((Activity) object, permissionsList.toArray(new String[permissionsList.size()]), requestCode);
        } else if (object instanceof Fragment) {
            ((Fragment) object).requestPermissions(permissionsList.toArray(new String[permissionsList.size()]), requestCode);
        }
    }
